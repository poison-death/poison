...
@section('txt')
    ...
    <script src="/lun/js/prefixfree.min.js"></script>
    <div class="banner">
      <!-- <ul class="texts">
      ...
      <div class="container" style="border-radius: 10px;">
        @foreach ($broadcast as $k=>$v)
          <img class='photo'  src="{{ $v->picture }}" alt="" />
        @endforeach
      </div>
    ...
    <div class="bloglist" style="margin-top: 140px;">
      <h2>
        <p><span>推荐</span>文章</p>
      </h2>
      <div class="blogs">
        <h3><a href="/">犯错了怎么办？</a></h3>
        <figure><img src="/h/images/01.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/h/images/02.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/h/images/03.png" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/h/images/04.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/h/images/04.png" ></figure>
        <ul>
